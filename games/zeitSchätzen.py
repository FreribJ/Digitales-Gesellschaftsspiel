...
# Pseudocode:
# Kurze Erklärung wie das Spiel funktionieren soll: Nach der Spieler- und Lebensauswahl beginnen die Spielrunden. Die LEDs leuchten eine zufällige Anzahl an Sekunden (Wahrscheinlich am besten zwischen 5 und 30 Sekunden oder sowas)
